...
func update_font() -> void:
	...
	var font_path: String = Saves.get_value("settings", "font", "res://fonts/AtkinsonHyperlegible-Regular.ttf")
	set("theme_override_fonts/normal_font", Helper.get_font(font_path))
	set("theme_override_font_sizes/normal_font_size", Saves.get_value("settings", "font_size", 15.0))
