...
func send_key(ID: int, this_target: int = 0) -> void:
	SteamP2P.send_message_to_user({"type": "encrypted_key", "message_id": ID, "key": encrypted_messages_sent[ID].save_to_string()}, this_target)
