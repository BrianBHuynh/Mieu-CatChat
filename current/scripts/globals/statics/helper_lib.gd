...
static func get_font(font_path: String) -> Font:
	if ResourceLoader.exists(font_path):
		...
		temp_font.load_dynamic_font(Saves.get_value("settings", "font", "res://current/assets/fonts/AtkinsonHyperlegible-Regular.ttf"))
		return temp_font
	elif (
		...
		var temp_font: FontFile = FontFile.new()
		temp_font.load_bitmap_font(Saves.get_value("settings", "font", "res://current/assets/fonts/AtkinsonHyperlegible-Regular.ttf"))
		return temp_font
	else:
