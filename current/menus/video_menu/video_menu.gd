...
func _ready() -> void:
	...
	$HBoxContainer/ScrollContainer/VBoxContainer/RenderingScaleLabel.text = "[center]3D Rendering scale: " + str($HBoxContainer/ScrollContainer/VBoxContainer/RenderingScale.value) + "[/center]"
